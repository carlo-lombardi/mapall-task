      ...
      {newData?.map((e, key) => {
        return (
          <>
            <div
              key={key}
              className="relative mt-8 ml-[150px] sm:ml-[148px] w-64 md:w-72 lg:w-72 xl:w-72 2xl:w-72"
            >
              ...
              <div className=" justify-between py-4 w-full text-black border-l-[12px] shadow-lg border-l-blueNetwork rounded-xl">
                <div className="flex items-center">
                  <p className="ml-8 w-full text-start">{e.simple}</p>
                  <span
                    onClick={deleteSimpleCell}
