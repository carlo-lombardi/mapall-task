    ...
    <div className="relative ml-[150px] sm:ml-[148px] w-64 mt-8 md:w-72 lg:w-72 xl:w-72 2xl:w-72">
      ...
      <div className=" justify-between py-4 w-full text-black border-l-[12px] shadow-lg border-l-blueNetwork rounded-xl">
        <div className="flex items-center">
          ...
          <span
            onClick={() => deleteComplexCell(e.complex.title)}
        ...
        {
          <>
            {e.complex.childValue.map((x, key) => (
              <div
                key={key}
                className="relative flex items-center w-[170px] ml-16 mt-4 border border-gray-300 rounded-md"
              >
                ...
                <p className="w-[150px] py-1 text-start pl-2">{x}</p>
                <span
                  onClick={() => deleteChildComplex(x, e.complex.title)}
                  className="mr-4 text-gray-500 text-2xl font-bold cursor-pointer"
                >
                  {" "}
                  <BiTrashAlt />{" "}
                </span>
        ...
        <div>
          <button
            onClick={() => {
              openChildModal(), setComplexValue(e.complex.title);
            }}
            ...
            <div className="bg-white h-44 w-96 p-2 rounded ">
              <div className="">
                ...
                <div className="text-black ">
                  ...
                  />
                  <OptionChildSelected key={e.complex.title} />
                </div>
              </div>
            </div>
          </div>
